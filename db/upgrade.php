...
function xmldb_threesixo_upgrade($oldversion) {
    ...
    if ($oldversion < 2018052605) {
        ...
        // Threesixo savepoint reached.
        upgrade_mod_savepoint(true, 2018052605, 'threesixo');
    }

    if ($oldversion < 2018052606) {
        ...
        // Threesixo savepoint reached.
        upgrade_mod_savepoint(true, 2018052606, 'threesixo');
    }
